...
Magnus - 3 hours learning react use states and react-bootstrap, 5 hours working on webscraper to get data to json, 6 hours on UI of site + search bar functionality. 
